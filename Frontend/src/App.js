...
import AdminMenuManagement from "./Pages/AdminMenuManagement"; // Add this import
...
import { MenuItemsProvider } from "./Components/MenuItems"; // Import MenuItemsProvider

function App() {
  return (
    <AuthProvider>
      <CartProvider> {/* Wrap the Router with CartProvider */}
        <MenuItemsProvider> {/* Wrap the Router with MenuItemsProvider */}
          <Router>
